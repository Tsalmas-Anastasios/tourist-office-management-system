                    ...
                    for (const row of plans_list_result.rows)
                        plans_list.push(new TravelPlan({
                            ...
                            accommodation_details: new Accommodation({
                                ...
                                location_details: {
                                    street: row['accommodation__street'],
                                    city: row['accommodation__city'],
                                    postal_code: row['accommodation__postal_code'],
                                    state: row['accommodation__state'],
                                    country: row['accommodation__country'],
                                    longitude: row['accommodation__longitude'],
                                    latitude: row['accommodation__latitude'],
                                },
                ...
                try {
                    ...
                    return res.status(200).send(new TravelPlan({
                        ...
                        accommodation_details: new Accommodation({
                            ...
                            location_details: {
                                street: plan_result.rows[0]['accommodation__street'],
                                city: plan_result.rows[0]['accommodation__city'],
                                postal_code: plan_result.rows[0]['accommodation__postal_code'],
                                state: plan_result.rows[0]['accommodation__state'],
                                country: plan_result.rows[0]['accommodation__country'],
                                longitude: plan_result.rows[0]['accommodation__longitude'],
                                latitude: plan_result.rows[0]['accommodation__latitude'],
                            },
